<section class="invoice">
  ...
  <div class="row">
    <div class="col-xs-12">
      <h2 class="page-header">
        <i class="fa fa-globe"></i> {{$stockout->branch->business_name.", ".$stockout->branch->branch_name}}
        <small class="pull-right">Date: {{$stockout->encode_date}}</small>
      </h2>
    </div>
    <!-- /.col -->
  </div>
  ...
  <div class="row invoice-info">
    ...
    <dl class="dl-horizontal">
      	<dt style="width: 78px">Series # : </dt><dd style="margin-left: 96px">{{$stockout->series_id}}</dd>
        
        <dt style="width: 78px">Status : </dt><dd style="margin-left: 96px">{{$stockout->approval->status}}</dd>
    </dl>	    
    </div>
    <!-- /.col -->
  </div>

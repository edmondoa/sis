<div class="box box-info">
  <div class="box-body">
    <div class="box-header with-border">
      <h3 class="box-title">Create Invoice
      ...
      <div class="panel-body">
        <form class='form-horizontal col-md-12'>
          <div class="row" style="min-height:80px" id='stockout-div'>
            ...
            <div class="col-md-4" >
              <div class="form-group ">
                <label for="inputEmail3"  class="col-sm-4 control-label">Account ID</label>
                <div class="col-sm-7">
                  <select class="form-control select2 stock "  id="branch_id" tabindex="1">
            ...
            <div class="col-md-4" >
              <div class="form-group ">
                ...
                <div class="col-sm-8">
                <input class='form-control' type='text' name='doc_no' id="doc_no"  value=""/>
                </div>
              </div>
              <div class="col-md-8">
  ...
  <fieldset class='col-sm-12 disabled-all' id='stockitem-div'>
    ...
    <table class='table table-bordered table-hover dataTable invoice-table' >
    	<thead>
    		...
    		<th class='col-md-5'>Prod Name</th>
